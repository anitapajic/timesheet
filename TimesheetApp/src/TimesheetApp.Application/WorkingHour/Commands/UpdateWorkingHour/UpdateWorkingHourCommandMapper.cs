...
public static class UpdateWorkingHourCommandMapper
{
    public static Domain.Models.WorkingHour ToDomain(this UpdateWorkingHourCommand command)
    {
    ...
    public static UpdateWorkingHourCommandResponse ToResponse(this Domain.Models.WorkingHour workingHour)
    {
        return new UpdateWorkingHourCommandResponse
        {
            Id = workingHour.Id,
